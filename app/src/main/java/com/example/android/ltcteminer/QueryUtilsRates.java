...
public final class QueryUtilsRates {
    public static final String LOG_TAG = QueryUtilsRates.class.getSimpleName();
     ...
     */
    private QueryUtilsRates() {
    }


    public static ArrayList<Double> extractRates(String requestUrl) {
        // Create URL object
