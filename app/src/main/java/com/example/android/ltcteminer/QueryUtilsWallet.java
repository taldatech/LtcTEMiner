...
public final class QueryUtilsWallet {
    public static final String LOG_TAG = QueryUtilsWallet.class.getSimpleName();
     ...
     */
    private QueryUtilsWallet() {
    }


    public static Double extractBalance(String requestUrl) {
        // Create URL object
        ...
        // Create an empty ArrayList that we can start adding rates to
        Double balance = 0.0; //Change to 0.0
        ...
        try {
            ...
            JSONObject dataCell =  root.getJSONObject("data");
            balance = dataCell.getDouble("balance");
