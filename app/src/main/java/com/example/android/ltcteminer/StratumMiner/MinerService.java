...
import com.example.android.ltcteminer.StratumMiner.Connection.IMiningConnection;
import com.example.android.ltcteminer.StratumMiner.Connection.StratumMiningConnection;
...
import static com.example.android.ltcteminer.StratumMiner.Constants.DEFAULT_RETRYPAUSE;
...
import static com.example.android.ltcteminer.StratumMiner.Constants.MSG_ACCEPTED_UPDATE;
import static com.example.android.ltcteminer.StratumMiner.Constants.MSG_CONSOLE_UPDATE;
import static com.example.android.ltcteminer.StratumMiner.Constants.MSG_REJECTED_UPDATE;
import static com.example.android.ltcteminer.StratumMiner.Constants.MSG_SPEED_UPDATE;
import static com.example.android.ltcteminer.StratumMiner.Constants.MSG_STATUS_UPDATE;
import static com.example.android.ltcteminer.StratumMiner.Constants.MSG_TERMINATED;
...
import static com.example.android.ltcteminer.StratumMiner.Constants.STATUS_NOT_MINING;
...
//        }
        ...
        try {
            ...
            int nProirity = settings.getInt(PREF_PRIORITY,DEFAULT_PRIORITY);
            imw = new CpuMiningWorker(nThread,DEFAULT_RETRYPAUSE,nProirity,console);
