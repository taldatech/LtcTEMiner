...
import com.example.android.ltcteminer.StratumMiner.Console;
import com.example.android.ltcteminer.StratumMiner.Hasher.Hasher;
...
public class CpuMiningWorker extends Observable implements IMiningWorker
{
    ...
    private class Worker extends Thread implements Runnable
    {
        ...
        private final static int NUMBER_OF_ROUND=100; //Original: 100, for debug: 1
