...
import com.example.android.ltcteminer.StratumMiner.Connection.IConnectionEvent;
...
import com.example.android.ltcteminer.StratumMiner.Worker.IWorkerEvent;

import java.util.Observable;
import java.util.Observer;

import static com.example.android.ltcteminer.StratumMiner.Constants.STATUS_CONNECTING;
import static com.example.android.ltcteminer.StratumMiner.Constants.STATUS_ERROR;
import static com.example.android.ltcteminer.StratumMiner.Constants.STATUS_MINING;
import static com.example.android.ltcteminer.StratumMiner.Constants.STATUS_NOT_MINING;
import static com.example.android.ltcteminer.StratumMiner.Constants.STATUS_TERMINATED;
...
public class SingleMiningChief implements Observer
{
    ...
    public SingleMiningChief(IMiningConnection i_connection,IMiningWorker i_worker, Console cons, Handler h) throws MinyaException
    {
        ...
        speed=0.0f;
        mainHandler=h;
        this.priority = ((CpuMiningWorker)i_worker)._thread_priorirty;
        this.console = cons;
    ...
    public void startMining() throws MinyaException
    {
        ...
        console.write("Starting Worker thread, priority: "+priority);
